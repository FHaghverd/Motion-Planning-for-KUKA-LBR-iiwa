...
#include "c2_simlwrkuka_kinematics.h"
...
static const char * c2_debug_family_names[19] = { "xf", "xi", "L", "v_max", "T",
  "a_max", "sig", "sigd", "Ts", "R_des", "eta_des", "e_des", "Q_des", "nargin",
  "nargout", "t", "x_des", "xd_des", "stop_sim" };

/* Function Declarations */
static void initialize_c2_simlwrkuka_kinematics
  (SFc2_simlwrkuka_kinematicsInstanceStruct *chartInstance);
static void initialize_params_c2_simlwrkuka_kinematics
  (SFc2_simlwrkuka_kinematicsInstanceStruct *chartInstance);
static void enable_c2_simlwrkuka_kinematics
  (SFc2_simlwrkuka_kinematicsInstanceStruct *chartInstance);
static void disable_c2_simlwrkuka_kinematics
  (SFc2_simlwrkuka_kinematicsInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_simlwrkuka_kinematics
  (SFc2_simlwrkuka_kinematicsInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_simlwrkuka_kinematics
  (SFc2_simlwrkuka_kinematicsInstanceStruct *chartInstance);
static void set_sim_state_c2_simlwrkuka_kinematics
  (SFc2_simlwrkuka_kinematicsInstanceStruct *chartInstance, const mxArray *c2_st);
static void finalize_c2_simlwrkuka_kinematics
  (SFc2_simlwrkuka_kinematicsInstanceStruct *chartInstance);
static void sf_gateway_c2_simlwrkuka_kinematics
  (SFc2_simlwrkuka_kinematicsInstanceStruct *chartInstance);
static void c2_chartstep_c2_simlwrkuka_kinematics
  (SFc2_simlwrkuka_kinematicsInstanceStruct *chartInstance);
static void initSimStructsc2_simlwrkuka_kinematics
  (SFc2_simlwrkuka_kinematicsInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_simlwrkuka_kinematicsInstanceStruct
  *chartInstance, const mxArray *c2_stop_sim, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_simlwrkuka_kinematicsInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_simlwrkuka_kinematicsInstanceStruct
  *chartInstance, const mxArray *c2_xd_des, const char_T *c2_identifier, real_T
  c2_y[6]);
static void c2_d_emlrt_marshallIn(SFc2_simlwrkuka_kinematicsInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[6]);
...
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_e_emlrt_marshallIn(SFc2_simlwrkuka_kinematicsInstanceStruct
  *chartInstance, const mxArray *c2_x_des, const char_T *c2_identifier, real_T
  c2_y[7]);
static void c2_f_emlrt_marshallIn(SFc2_simlwrkuka_kinematicsInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[7]);
...
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_g_emlrt_marshallIn(SFc2_simlwrkuka_kinematicsInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[4]);
...
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_h_emlrt_marshallIn(SFc2_simlwrkuka_kinematicsInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[3]);
...
static real_T c2_mpower(SFc2_simlwrkuka_kinematicsInstanceStruct *chartInstance,
  real_T c2_a);
static void c2_eml_scalar_eg(SFc2_simlwrkuka_kinematicsInstanceStruct
  *chartInstance);
static const mxArray *c2_g_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_i_emlrt_marshallIn(SFc2_simlwrkuka_kinematicsInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_j_emlrt_marshallIn(SFc2_simlwrkuka_kinematicsInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_simlwrkuka_kinematics, const
  char_T *c2_identifier);
static uint8_T c2_k_emlrt_marshallIn(SFc2_simlwrkuka_kinematicsInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_simlwrkuka_kinematicsInstanceStruct
  *chartInstance);
  ...
  (SFc2_simlwrkuka_kinematicsInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_simlwrkuka_kinematics = 0U;
}
  ...
  (SFc2_simlwrkuka_kinematicsInstanceStruct *chartInstance)
{
  ...
  real_T (*c2_xd_des)[6];
  real_T (*c2_x_des)[7];
  c2_stop_sim = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
  ...
  c2_b_hoistedGlobal = chartInstance->c2_is_active_c2_simlwrkuka_kinematics;
  ...
  (SFc2_simlwrkuka_kinematicsInstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_stop_sim = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  for (c2_i2 = 0; c2_i2 < 7; c2_i2++) {
    (*c2_x_des)[c2_i2] = c2_dv0[c2_i2];
  }

  c2_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
                        "xd_des", c2_dv1);
  for (c2_i3 = 0; c2_i3 < 6; c2_i3++) {
    (*c2_xd_des)[c2_i3] = c2_dv1[c2_i3];
  }

  chartInstance->c2_is_active_c2_simlwrkuka_kinematics = c2_j_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 3)),
     "is_active_c2_simlwrkuka_kinematics");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_simlwrkuka_kinematics(chartInstance);
  ...
  (SFc2_simlwrkuka_kinematicsInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_simlwrkuka_kinematics(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_simlwrkuka_kinematicsMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  for (c2_i4 = 0; c2_i4 < 7; c2_i4++) {
    _SFD_DATA_RANGE_CHECK((*c2_x_des)[c2_i4], 1U);
  }

  for (c2_i5 = 0; c2_i5 < 6; c2_i5++) {
    _SFD_DATA_RANGE_CHECK((*c2_xd_des)[c2_i5], 2U);
  }

  _SFD_DATA_RANGE_CHECK(*c2_stop_sim, 3U);
}
  ...
  (SFc2_simlwrkuka_kinematicsInstanceStruct *chartInstance)
{
  ...
  real_T c2_stop_sim;
  int32_T c2_i6;
  static real_T c2_dv2[3] = { 0.085, -0.085, 0.597 };

  int32_T c2_i7;
  static real_T c2_dv3[3] = { 0.0, -0.39, 0.61 };
  ...
  real_T c2_y;
  int32_T c2_i8;
  static real_T c2_dv4[9] = { -0.866, 0.5, 0.0, -0.5, -0.866, 0.0, 0.0, 0.0, 1.0
  };

  int32_T c2_i9;
  static real_T c2_dv5[3] = { 0.0, 0.0, 0.96591925128346 };
  ...
  c2_b_stop_sim = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_sigd, 7U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_Ts, 8U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_R_des, 9U, c2_f_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_eta_des, 10U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_e_des, 11U, c2_e_sf_marshallOut,
    c2_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_Q_des, 12U, c2_d_sf_marshallOut,
    c2_d_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 14U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_t, 15U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_x_des, 16U, c2_c_sf_marshallOut,
    c2_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_xd_des, 17U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_stop_sim, 18U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 3);
  for (c2_i6 = 0; c2_i6 < 3; c2_i6++) {
    c2_xf[c2_i6] = c2_dv2[c2_i6];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 4);
  for (c2_i7 = 0; c2_i7 < 3; c2_i7++) {
    c2_xi[c2_i7] = c2_dv3[c2_i7];
  }
  ...
  c2_Ts = 0.66220858658160076;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 15);
  if (CV_EML_IF(0, 1, 0, c2_t <= c2_Ts)) {
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 16);
    c2_A = 0.075504910406109252 * c2_mpower(chartInstance, c2_t);
    c2_x = c2_A;
    c2_b_x = c2_x;
    c2_c_x = c2_b_x;
    c2_sig = c2_c_x / 2.0;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 17);
    c2_sigd = 0.075504910406109252 * c2_t;
  } else {
    ...
    if (CV_EML_COND(0, 1, 0, c2_t > c2_Ts)) {
      if (CV_EML_COND(0, 1, 1, c2_t <= c2_T - c2_Ts)) {
        ...
        c2_sig = 0.05 * c2_t - 0.016555214664540019;
    ...
    if (guard1 == true) {
      ...
      if (CV_EML_COND(0, 1, 2, c2_t > c2_T - c2_Ts)) {
        if (CV_EML_COND(0, 1, 3, c2_t <= c2_T)) {
          ...
          c2_b_A = -0.075504910406109252 * c2_mpower(chartInstance, c2_t - c2_T);
          c2_d_x = c2_b_A;
          c2_e_x = c2_d_x;
          c2_f_x = c2_e_x;
          c2_y = c2_f_x / 2.0;
          c2_sig = (c2_y + 0.35000000000000003) - 0.033110429329080038;
          _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 25);
          c2_sigd = -0.075504910406109252 * (c2_t - c2_T);
        } else {
          guard2 = true;
        }
      } else {
  ...
  for (c2_i17 = 0; c2_i17 < 7; c2_i17++) {
    (*c2_b_x_des)[c2_i17] = c2_x_des[c2_i17];
  }

  for (c2_i18 = 0; c2_i18 < 6; c2_i18++) {
    (*c2_b_xd_des)[c2_i18] = c2_xd_des[c2_i18];
  }
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_simlwrkuka_kinematicsInstanceStruct *chartInstance;
  chartInstance = (SFc2_simlwrkuka_kinematicsInstanceStruct *)chartInstanceVoid;
  ...
  real_T c2_y[7])
{
  ...
  int32_T c2_i25;
  (void)chartInstance;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_u), c2_dv7, 1, 0, 0U, 1, 0U, 1, 7);
  ...
  *c2_inData)
{
  ...
  for (c2_i27 = 0; c2_i27 < 4; c2_i27++) {
    c2_b_inData[c2_i27] = (*(real_T (*)[4])c2_inData)[c2_i27];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  for (c2_i30 = 0; c2_i30 < 4; c2_i30++) {
    (*(real_T (*)[4])c2_outData)[c2_i30] = c2_y[c2_i30];
  }
  ...
  *c2_inData)
{
  ...
  for (c2_i31 = 0; c2_i31 < 3; c2_i31++) {
    c2_b_inData[c2_i31] = (*(real_T (*)[3])c2_inData)[c2_i31];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  for (c2_i34 = 0; c2_i34 < 3; c2_i34++) {
    (*(real_T (*)[3])c2_outData)[c2_i34] = c2_y[c2_i34];
  }
  ...
  *c2_inData)
{
  ...
  for (c2_i36 = 0; c2_i36 < 3; c2_i36++) {
    for (c2_i37 = 0; c2_i37 < 3; c2_i37++) {
      c2_b_inData[c2_i37 + c2_i35] = (*(real_T (*)[9])c2_inData)[c2_i37 + c2_i35];
    }
...
const mxArray *sf_c2_simlwrkuka_kinematics_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_simlwrkuka_kinematics), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_simlwrkuka_kinematics);
  return c2_y;
}
...
void sf_c2_simlwrkuka_kinematics_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1772889167U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2405542739U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1738155792U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4006709983U);
}

mxArray *sf_c2_simlwrkuka_kinematics_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("Q4XV6HbV5YzesQr2dMCy1G");
...
mxArray *sf_c2_simlwrkuka_kinematics_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_simlwrkuka_kinematics_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_simlwrkuka_kinematics(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[6],T\"stop_sim\",},{M[1],M[5],T\"x_des\",},{M[1],M[7],T\"xd_des\",},{M[8],M[0],T\"is_active_c2_simlwrkuka_kinematics\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_simlwrkuka_kinematics_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_simlwrkuka_kinematicsInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(3,2,0,1,"stop_sim");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1426);
        _SFD_CV_INIT_EML_IF(0,1,0,330,338,397,637);
        _SFD_CV_INIT_EML_IF(0,1,1,397,421,490,637);
        _SFD_CV_INIT_EML_IF(0,1,2,490,513,607,637);

        {
          static int condStart[] = { 404, 412 };

          static int condEnd[] = { 408, 421 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,404,421,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 497, 509 };

          static int condEnd[] = { 505, 513 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,1,497,513,2,2,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(3U, c2_stop_sim);
        }
      }
    } else {
...
{
  return "GCoQnPHAL3njMHwhZ4fFRE";
}

static void sf_opaque_initialize_c2_simlwrkuka_kinematics(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_simlwrkuka_kinematicsInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_simlwrkuka_kinematics
    ((SFc2_simlwrkuka_kinematicsInstanceStruct*) chartInstanceVar);
  initialize_c2_simlwrkuka_kinematics((SFc2_simlwrkuka_kinematicsInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_simlwrkuka_kinematics(void *chartInstanceVar)
{
  enable_c2_simlwrkuka_kinematics((SFc2_simlwrkuka_kinematicsInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_simlwrkuka_kinematics(void *chartInstanceVar)
{
  disable_c2_simlwrkuka_kinematics((SFc2_simlwrkuka_kinematicsInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_simlwrkuka_kinematics(void *chartInstanceVar)
{
  sf_gateway_c2_simlwrkuka_kinematics((SFc2_simlwrkuka_kinematicsInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_simlwrkuka_kinematics
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_simlwrkuka_kinematics
    ((SFc2_simlwrkuka_kinematicsInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_simlwrkuka_kinematics();/* state var info */
...
extern void sf_internal_set_sim_state_c2_simlwrkuka_kinematics(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_simlwrkuka_kinematics();/* state var info */
  ...
  set_sim_state_c2_simlwrkuka_kinematics
    ((SFc2_simlwrkuka_kinematicsInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_simlwrkuka_kinematics(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c2_simlwrkuka_kinematics(S);
}

static void sf_opaque_set_sim_state_c2_simlwrkuka_kinematics(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c2_simlwrkuka_kinematics(S, st);
}

static void sf_opaque_terminate_c2_simlwrkuka_kinematics(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_simlwrkuka_kinematicsInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_simlwrkuka_kinematics((SFc2_simlwrkuka_kinematicsInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_simlwrkuka_kinematics
    ((SFc2_simlwrkuka_kinematicsInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_simlwrkuka_kinematics(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_simlwrkuka_kinematics(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2839903779U));
  ssSetChecksum1(S,(1842513520U));
  ssSetChecksum2(S,(690000890U));
  ssSetChecksum3(S,(71410775U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_simlwrkuka_kinematics(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_simlwrkuka_kinematics(SimStruct *S)
{
  SFc2_simlwrkuka_kinematicsInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_simlwrkuka_kinematicsInstanceStruct *)utMalloc(sizeof
    (SFc2_simlwrkuka_kinematicsInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_simlwrkuka_kinematicsInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_simlwrkuka_kinematics;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_simlwrkuka_kinematics;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_simlwrkuka_kinematics;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_simlwrkuka_kinematics;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_simlwrkuka_kinematics;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_simlwrkuka_kinematics;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_simlwrkuka_kinematics;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_simlwrkuka_kinematics;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_simlwrkuka_kinematics;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_simlwrkuka_kinematics;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_simlwrkuka_kinematics;
...
void c2_simlwrkuka_kinematics_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_simlwrkuka_kinematics(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_simlwrkuka_kinematics(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_simlwrkuka_kinematics(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_simlwrkuka_kinematics_method_dispatcher.\n"
