...
static const char * c2_debug_family_names[21] = { "xf", "xi", "L", "v_max", "T",
  "a_max", "sig", "sigd", "sigdd", "Ts", "R_des", "eta_des", "e_des", "Q_des",
  "nargin", "nargout", "t", "x_des", "xd_des", "xdd_des", "stop_sim" };

/* Function Declarations */
static void initialize_c2_simlwrkuka_dynamic
  (SFc2_simlwrkuka_dynamicInstanceStruct *chartInstance);
static void initialize_params_c2_simlwrkuka_dynamic
  (SFc2_simlwrkuka_dynamicInstanceStruct *chartInstance);
static void enable_c2_simlwrkuka_dynamic(SFc2_simlwrkuka_dynamicInstanceStruct
  *chartInstance);
static void disable_c2_simlwrkuka_dynamic(SFc2_simlwrkuka_dynamicInstanceStruct *
  chartInstance);
static void c2_update_debugger_state_c2_simlwrkuka_dynamic
  (SFc2_simlwrkuka_dynamicInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_simlwrkuka_dynamic
  (SFc2_simlwrkuka_dynamicInstanceStruct *chartInstance);
static void set_sim_state_c2_simlwrkuka_dynamic
  (SFc2_simlwrkuka_dynamicInstanceStruct *chartInstance, const mxArray *c2_st);
static void finalize_c2_simlwrkuka_dynamic(SFc2_simlwrkuka_dynamicInstanceStruct
  *chartInstance);
static void sf_gateway_c2_simlwrkuka_dynamic
  (SFc2_simlwrkuka_dynamicInstanceStruct *chartInstance);
static void c2_chartstep_c2_simlwrkuka_dynamic
  (SFc2_simlwrkuka_dynamicInstanceStruct *chartInstance);
static void initSimStructsc2_simlwrkuka_dynamic
  (SFc2_simlwrkuka_dynamicInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_simlwrkuka_dynamicInstanceStruct
  *chartInstance, const mxArray *c2_stop_sim, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_simlwrkuka_dynamicInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_simlwrkuka_dynamicInstanceStruct
  *chartInstance, const mxArray *c2_xdd_des, const char_T *c2_identifier, real_T
  c2_y[6]);
static void c2_d_emlrt_marshallIn(SFc2_simlwrkuka_dynamicInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[6]);
...
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_e_emlrt_marshallIn(SFc2_simlwrkuka_dynamicInstanceStruct
  *chartInstance, const mxArray *c2_x_des, const char_T *c2_identifier, real_T
  c2_y[7]);
static void c2_f_emlrt_marshallIn(SFc2_simlwrkuka_dynamicInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[7]);
...
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_g_emlrt_marshallIn(SFc2_simlwrkuka_dynamicInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[4]);
...
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_h_emlrt_marshallIn(SFc2_simlwrkuka_dynamicInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[3]);
...
static real_T c2_mpower(SFc2_simlwrkuka_dynamicInstanceStruct *chartInstance,
  real_T c2_a);
static void c2_eml_scalar_eg(SFc2_simlwrkuka_dynamicInstanceStruct
  *chartInstance);
static const mxArray *c2_g_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_i_emlrt_marshallIn(SFc2_simlwrkuka_dynamicInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_j_emlrt_marshallIn(SFc2_simlwrkuka_dynamicInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_simlwrkuka_dynamic, const
  char_T *c2_identifier);
static uint8_T c2_k_emlrt_marshallIn(SFc2_simlwrkuka_dynamicInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_simlwrkuka_dynamicInstanceStruct
  *chartInstance);
  ...
  (SFc2_simlwrkuka_dynamicInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_simlwrkuka_dynamic = 0U;
}
  ...
  (SFc2_simlwrkuka_dynamicInstanceStruct *chartInstance)
{
  ...
  real_T (*c2_xd_des)[6];
  real_T (*c2_x_des)[7];
  c2_stop_sim = (real_T *)ssGetOutputPortSignal(chartInstance->S, 4);
  c2_xdd_des = (real_T (*)[6])ssGetOutputPortSignal(chartInstance->S, 3);
  c2_xd_des = (real_T (*)[6])ssGetOutputPortSignal(chartInstance->S, 2);
  c2_x_des = (real_T (*)[7])ssGetOutputPortSignal(chartInstance->S, 1);
  c2_st = NULL;
  c2_st = NULL;
  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_createcellmatrix(5, 1), false);
  c2_hoistedGlobal = *c2_stop_sim;
  c2_u = c2_hoistedGlobal;
  c2_b_y = NULL;
  sf_mex_assign(&c2_b_y, sf_mex_create("y", &c2_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c2_y, 0, c2_b_y);
  for (c2_i0 = 0; c2_i0 < 7; c2_i0++) {
    c2_b_u[c2_i0] = (*c2_x_des)[c2_i0];
  }

  c2_c_y = NULL;
  sf_mex_assign(&c2_c_y, sf_mex_create("y", c2_b_u, 0, 0U, 1U, 0U, 1, 7), false);
  sf_mex_setcell(c2_y, 1, c2_c_y);
  for (c2_i1 = 0; c2_i1 < 6; c2_i1++) {
    c2_c_u[c2_i1] = (*c2_xd_des)[c2_i1];
  }
  ...
  for (c2_i2 = 0; c2_i2 < 6; c2_i2++) {
    c2_d_u[c2_i2] = (*c2_xdd_des)[c2_i2];
  }

  c2_e_y = NULL;
  sf_mex_assign(&c2_e_y, sf_mex_create("y", c2_d_u, 0, 0U, 1U, 0U, 1, 6), false);
  sf_mex_setcell(c2_y, 3, c2_e_y);
  c2_b_hoistedGlobal = chartInstance->c2_is_active_c2_simlwrkuka_dynamic;
  ...
  (SFc2_simlwrkuka_dynamicInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_simlwrkuka_dynamic(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_simlwrkuka_dynamicMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  for (c2_i6 = 0; c2_i6 < 7; c2_i6++) {
    _SFD_DATA_RANGE_CHECK((*c2_x_des)[c2_i6], 1U);
  }

  for (c2_i7 = 0; c2_i7 < 6; c2_i7++) {
    _SFD_DATA_RANGE_CHECK((*c2_xd_des)[c2_i7], 2U);
  }

  for (c2_i8 = 0; c2_i8 < 6; c2_i8++) {
    _SFD_DATA_RANGE_CHECK((*c2_xdd_des)[c2_i8], 3U);
  }

  _SFD_DATA_RANGE_CHECK(*c2_stop_sim, 4U);
}
  ...
  (SFc2_simlwrkuka_dynamicInstanceStruct *chartInstance)
{
  ...
  real_T c2_stop_sim;
  int32_T c2_i9;
  static real_T c2_dv3[3] = { 0.085, -0.085, 0.597 };

  int32_T c2_i10;
  static real_T c2_dv4[3] = { 0.0, -0.39, 0.61 };
  ...
  real_T c2_y;
  int32_T c2_i11;
  static real_T c2_dv5[9] = { -0.866, 0.5, 0.0, -0.5, -0.866, 0.0, 0.0, 0.0, 1.0
  };

  int32_T c2_i12;
  static real_T c2_dv6[3] = { 0.0, 0.0, 0.96591925128346 };

  int32_T c2_i13;
  real_T c2_a;
  int32_T c2_i14;
  static real_T c2_b[3] = { 0.085, 0.305, -0.013000000000000012 };
  ...
  real_T c2_b_b;
  int32_T c2_i18;
  static real_T c2_b_a[3] = { 0.26823224197640089, 0.96248039768002669,
    -0.041023754655214288 };
  ...
  int32_T c2_i23;
  int32_T c2_i24;
  real_T *c2_b_stop_sim;
  real_T *c2_b_t;
  real_T (*c2_b_x_des)[7];
  real_T (*c2_b_xd_des)[6];
  real_T (*c2_b_xdd_des)[6];
  boolean_T guard1 = false;
  boolean_T guard2 = false;
  c2_b_stop_sim = (real_T *)ssGetOutputPortSignal(chartInstance->S, 4);
  c2_b_xdd_des = (real_T (*)[6])ssGetOutputPortSignal(chartInstance->S, 3);
  c2_b_xd_des = (real_T (*)[6])ssGetOutputPortSignal(chartInstance->S, 2);
  c2_b_x_des = (real_T (*)[7])ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_xf, 0U, c2_e_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_xi, 1U, c2_e_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_L, 2U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_v_max, 3U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_T, 4U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_a_max, 5U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_sig, 6U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_sigd, 7U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_sigdd, 8U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_Ts, 9U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_R_des, 10U, c2_f_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_eta_des, 11U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_e_des, 12U, c2_e_sf_marshallOut,
    c2_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_Q_des, 13U, c2_d_sf_marshallOut,
    c2_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargin, 14U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 15U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_t, 16U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_x_des, 17U, c2_c_sf_marshallOut,
    c2_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_xd_des, 18U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_xdd_des, 19U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_stop_sim, 20U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 3);
  for (c2_i9 = 0; c2_i9 < 3; c2_i9++) {
    c2_xf[c2_i9] = c2_dv3[c2_i9];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 4);
  for (c2_i10 = 0; c2_i10 < 3; c2_i10++) {
    c2_xi[c2_i10] = c2_dv4[c2_i10];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 5);
  c2_L = 0.31688957067092;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 6);
  c2_v_max = 0.045;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 7);
  c2_T = 7.0;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 8);
  c2_a_max = -1.0716720105599802;
  ...
  c2_Ts = -0.041990459353777626;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 15);
  if (CV_EML_IF(0, 1, 0, c2_t <= c2_Ts)) {
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 16);
    c2_A = -1.0716720105599802 * c2_mpower(chartInstance, c2_t);
    c2_x = c2_A;
    c2_b_x = c2_x;
    c2_c_x = c2_b_x;
    c2_sig = c2_c_x / 2.0;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 17);
    c2_sigd = -1.0716720105599802 * c2_t;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 18);
    c2_sigdd = c2_a_max;
  } else {
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 19);
    guard1 = false;
    if (CV_EML_COND(0, 1, 0, c2_t > c2_Ts)) {
      if (CV_EML_COND(0, 1, 1, c2_t <= c2_T - c2_Ts)) {
        CV_EML_MCDC(0, 1, 0, true);
        CV_EML_IF(0, 1, 1, true);
        _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 20);
        c2_sig = 0.045 * c2_t - -0.00094478533545999666;
    ...
    if (guard1 == true) {
      ...
      guard2 = false;
      if (CV_EML_COND(0, 1, 2, c2_t > c2_T - c2_Ts)) {
        if (CV_EML_COND(0, 1, 3, c2_t <= c2_T)) {
          CV_EML_MCDC(0, 1, 1, true);
          CV_EML_IF(0, 1, 2, true);
          _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 24);
          c2_b_A = 1.0716720105599802 * c2_mpower(chartInstance, c2_t - c2_T);
          c2_d_x = c2_b_A;
          c2_e_x = c2_d_x;
          c2_f_x = c2_e_x;
          c2_y = c2_f_x / 2.0;
          c2_sig = (c2_y + 0.315) - -0.0018895706709199933;
          _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 25);
          c2_sigd = 1.0716720105599802 * (c2_t - c2_T);
  ...
  for (c2_i11 = 0; c2_i11 < 9; c2_i11++) {
    c2_R_des[c2_i11] = c2_dv5[c2_i11];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 33);
  c2_eta_des = 0.2588435821108957;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 34);
  for (c2_i12 = 0; c2_i12 < 3; c2_i12++) {
    c2_e_des[c2_i12] = c2_dv6[c2_i12];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 37);
  c2_Q_des[0] = c2_eta_des;
  for (c2_i13 = 0; c2_i13 < 3; c2_i13++) {
    c2_Q_des[c2_i13 + 1] = c2_e_des[c2_i13];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 38);
  c2_a = c2_sig;
  for (c2_i14 = 0; c2_i14 < 3; c2_i14++) {
    c2_b_y[c2_i14] = c2_a * c2_b[c2_i14];
  }

  for (c2_i15 = 0; c2_i15 < 3; c2_i15++) {
    c2_b_y[c2_i15] /= 0.31688957067092;
  }

  for (c2_i16 = 0; c2_i16 < 3; c2_i16++) {
    c2_x_des[c2_i16] = c2_xi[c2_i16] + c2_b_y[c2_i16];
  }

  for (c2_i17 = 0; c2_i17 < 4; c2_i17++) {
    c2_x_des[c2_i17 + 3] = c2_Q_des[c2_i17];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 39);
  c2_b_b = c2_sigd;
  for (c2_i18 = 0; c2_i18 < 3; c2_i18++) {
    c2_b_y[c2_i18] = c2_b_a[c2_i18] * c2_b_b;
  }

  for (c2_i19 = 0; c2_i19 < 3; c2_i19++) {
    c2_xd_des[c2_i19] = c2_b_y[c2_i19];
  }
  ...
  for (c2_i20 = 0; c2_i20 < 3; c2_i20++) {
    c2_b_y[c2_i20] = c2_b_a[c2_i20] * c2_c_b;
  }

  for (c2_i21 = 0; c2_i21 < 3; c2_i21++) {
    c2_xdd_des[c2_i21] = c2_b_y[c2_i21];
  }
  ...
  for (c2_i22 = 0; c2_i22 < 7; c2_i22++) {
    (*c2_b_x_des)[c2_i22] = c2_x_des[c2_i22];
  }

  for (c2_i23 = 0; c2_i23 < 6; c2_i23++) {
    (*c2_b_xd_des)[c2_i23] = c2_xd_des[c2_i23];
  }

  for (c2_i24 = 0; c2_i24 < 6; c2_i24++) {
    (*c2_b_xdd_des)[c2_i24] = c2_xdd_des[c2_i24];
  }

  *c2_b_stop_sim = c2_stop_sim;
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_simlwrkuka_dynamicInstanceStruct *chartInstance;
  chartInstance = (SFc2_simlwrkuka_dynamicInstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c2_stop_sim, const char_T *c2_identifier)
{
  ...
  c2_y = c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_stop_sim),
    &c2_thisId);
  sf_mex_destroy(&c2_stop_sim);
  return c2_y;
}
...
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  const mxArray *c2_stop_sim;
  const char_T *c2_identifier;
  emlrtMsgIdentifier c2_thisId;
  real_T c2_y;
  SFc2_simlwrkuka_dynamicInstanceStruct *chartInstance;
  chartInstance = (SFc2_simlwrkuka_dynamicInstanceStruct *)chartInstanceVoid;
  c2_stop_sim = sf_mex_dup(c2_mxArrayInData);
  ...
  *c2_inData)
{
  ...
  for (c2_i25 = 0; c2_i25 < 6; c2_i25++) {
    c2_b_inData[c2_i25] = (*(real_T (*)[6])c2_inData)[c2_i25];
  }
  ...
  c2_y[6])
{
  ...
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_xdd_des), &c2_thisId, c2_y);
  sf_mex_destroy(&c2_xdd_des);
}
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  SFc2_simlwrkuka_dynamicInstanceStruct *chartInstance;
  chartInstance = (SFc2_simlwrkuka_dynamicInstanceStruct *)chartInstanceVoid;
  c2_xdd_des = sf_mex_dup(c2_mxArrayInData);
  c2_identifier = c2_varName;
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_xdd_des), &c2_thisId, c2_y);
  ...
  for (c2_i28 = 0; c2_i28 < 6; c2_i28++) {
    (*(real_T (*)[6])c2_outData)[c2_i28] = c2_y[c2_i28];
  }
  ...
  *c2_inData)
{
  ...
  for (c2_i29 = 0; c2_i29 < 7; c2_i29++) {
    c2_b_inData[c2_i29] = (*(real_T (*)[7])c2_inData)[c2_i29];
  }
  ...
  c2_y[7])
{
  ...
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_f_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_x_des), &c2_thisId, c2_y);
  sf_mex_destroy(&c2_x_des);
}
  ...
  real_T c2_y[7])
{
  ...
  int32_T c2_i31;
  (void)chartInstance;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_u), c2_dv8, 1, 0, 0U, 1, 0U, 1, 7);
  for (c2_i31 = 0; c2_i31 < 7; c2_i31++) {
    c2_y[c2_i31] = c2_dv8[c2_i31];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  SFc2_simlwrkuka_dynamicInstanceStruct *chartInstance;
  chartInstance = (SFc2_simlwrkuka_dynamicInstanceStruct *)chartInstanceVoid;
  c2_x_des = sf_mex_dup(c2_mxArrayInData);
  c2_identifier = c2_varName;
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_f_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_x_des), &c2_thisId, c2_y);
  ...
  for (c2_i32 = 0; c2_i32 < 7; c2_i32++) {
    (*(real_T (*)[7])c2_outData)[c2_i32] = c2_y[c2_i32];
  }
  ...
  *c2_inData)
{
  ...
  for (c2_i33 = 0; c2_i33 < 4; c2_i33++) {
    c2_b_inData[c2_i33] = (*(real_T (*)[4])c2_inData)[c2_i33];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  SFc2_simlwrkuka_dynamicInstanceStruct *chartInstance;
  chartInstance = (SFc2_simlwrkuka_dynamicInstanceStruct *)chartInstanceVoid;
  c2_Q_des = sf_mex_dup(c2_mxArrayInData);
  c2_identifier = c2_varName;
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_Q_des), &c2_thisId, c2_y);
  sf_mex_destroy(&c2_Q_des);
  for (c2_i36 = 0; c2_i36 < 4; c2_i36++) {
    (*(real_T (*)[4])c2_outData)[c2_i36] = c2_y[c2_i36];
  }
  ...
  *c2_inData)
{
  ...
  for (c2_i37 = 0; c2_i37 < 3; c2_i37++) {
    c2_b_inData[c2_i37] = (*(real_T (*)[3])c2_inData)[c2_i37];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  SFc2_simlwrkuka_dynamicInstanceStruct *chartInstance;
  chartInstance = (SFc2_simlwrkuka_dynamicInstanceStruct *)chartInstanceVoid;
  c2_e_des = sf_mex_dup(c2_mxArrayInData);
  c2_identifier = c2_varName;
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_h_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_e_des), &c2_thisId, c2_y);
  sf_mex_destroy(&c2_e_des);
  for (c2_i40 = 0; c2_i40 < 3; c2_i40++) {
    (*(real_T (*)[3])c2_outData)[c2_i40] = c2_y[c2_i40];
  }
  ...
  *c2_inData)
{
  ...
  for (c2_i42 = 0; c2_i42 < 3; c2_i42++) {
    for (c2_i43 = 0; c2_i43 < 3; c2_i43++) {
      c2_b_inData[c2_i43 + c2_i41] = (*(real_T (*)[9])c2_inData)[c2_i43 + c2_i41];
    }
  ...
  for (c2_i45 = 0; c2_i45 < 3; c2_i45++) {
    for (c2_i46 = 0; c2_i46 < 3; c2_i46++) {
      c2_u[c2_i46 + c2_i44] = c2_b_inData[c2_i46 + c2_i44];
    }
...
const mxArray *sf_c2_simlwrkuka_dynamic_get_eml_resolved_functions_info(void)
{
  const mxArray *c2_nameCaptureInfo = NULL;
  c2_nameCaptureInfo = NULL;
  sf_mex_assign(&c2_nameCaptureInfo, sf_mex_createstruct("structure", 2, 50, 1),
                false);
...
static void c2_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("mpower"), "name", "name", 22);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 22);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 24);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("ismatrix"), "name", "name", 24);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 24);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 25);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("power"), "name", "name", 25);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 25);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 37);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("rdivide"), "name", "name", 37);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 37);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 40);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("eml_div"), "name", "name", 40);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 40);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("sqrt"), "name", "name", 42);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 42);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("sign"), "name", "name", 45);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 45);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_simlwrkuka_dynamic), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_simlwrkuka_dynamic);
  return c2_y;
}
...
void sf_c2_simlwrkuka_dynamic_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1337669840U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1298672954U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3270049507U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2120439138U);
}

mxArray *sf_c2_simlwrkuka_dynamic_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("LU7RbMTT00Bcpm6GxYqEOC");
...
mxArray *sf_c2_simlwrkuka_dynamic_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_simlwrkuka_dynamic_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_simlwrkuka_dynamic(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[6],T\"stop_sim\",},{M[1],M[5],T\"x_des\",},{M[1],M[7],T\"xd_des\",},{M[1],M[8],T\"xdd_des\",},{M[8],M[0],T\"is_active_c2_simlwrkuka_dynamic\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_simlwrkuka_dynamic_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_simlwrkuka_dynamicInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(1,2,0,1,"x_des");
          _SFD_SET_DATA_PROPS(2,2,0,1,"xd_des");
          _SFD_SET_DATA_PROPS(3,2,0,1,"xdd_des");
          _SFD_SET_DATA_PROPS(4,2,0,1,"stop_sim");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1202);
        _SFD_CV_INIT_EML_IF(0,1,0,273,281,338,574);
        _SFD_CV_INIT_EML_IF(0,1,1,338,362,429,574);
        _SFD_CV_INIT_EML_IF(0,1,2,429,452,544,574);

        {
          static int condStart[] = { 345, 353 };

          static int condEnd[] = { 349, 362 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,345,362,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 436, 448 };

          static int condEnd[] = { 444, 452 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,1,436,452,2,2,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(1U, *c2_x_des);
          _SFD_SET_DATA_VALUE_PTR(2U, *c2_xd_des);
          _SFD_SET_DATA_VALUE_PTR(3U, *c2_xdd_des);
          _SFD_SET_DATA_VALUE_PTR(4U, c2_stop_sim);
        }
      }
    } else {
...
{
  return "qIrlZAMuUfNeOvBCORijQG";
}

static void sf_opaque_initialize_c2_simlwrkuka_dynamic(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_simlwrkuka_dynamicInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_simlwrkuka_dynamic((SFc2_simlwrkuka_dynamicInstanceStruct*)
    chartInstanceVar);
  initialize_c2_simlwrkuka_dynamic((SFc2_simlwrkuka_dynamicInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_simlwrkuka_dynamic(void *chartInstanceVar)
{
  enable_c2_simlwrkuka_dynamic((SFc2_simlwrkuka_dynamicInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_simlwrkuka_dynamic(void *chartInstanceVar)
{
  disable_c2_simlwrkuka_dynamic((SFc2_simlwrkuka_dynamicInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_simlwrkuka_dynamic(void *chartInstanceVar)
{
  sf_gateway_c2_simlwrkuka_dynamic((SFc2_simlwrkuka_dynamicInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_simlwrkuka_dynamic(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_simlwrkuka_dynamic
    ((SFc2_simlwrkuka_dynamicInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_simlwrkuka_dynamic();/* state var info */
...
extern void sf_internal_set_sim_state_c2_simlwrkuka_dynamic(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_simlwrkuka_dynamic();/* state var info */
  ...
  set_sim_state_c2_simlwrkuka_dynamic((SFc2_simlwrkuka_dynamicInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_simlwrkuka_dynamic(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_simlwrkuka_dynamic(S);
}

static void sf_opaque_set_sim_state_c2_simlwrkuka_dynamic(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c2_simlwrkuka_dynamic(S, st);
}

static void sf_opaque_terminate_c2_simlwrkuka_dynamic(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_simlwrkuka_dynamicInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_simlwrkuka_dynamic((SFc2_simlwrkuka_dynamicInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_simlwrkuka_dynamic((SFc2_simlwrkuka_dynamicInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_simlwrkuka_dynamic(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c2_simlwrkuka_dynamic
      ((SFc2_simlwrkuka_dynamicInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_simlwrkuka_dynamic(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2345965754U));
  ssSetChecksum1(S,(277146258U));
  ssSetChecksum2(S,(1240082857U));
  ssSetChecksum3(S,(3194298910U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_simlwrkuka_dynamic(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_simlwrkuka_dynamic(SimStruct *S)
{
  SFc2_simlwrkuka_dynamicInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_simlwrkuka_dynamicInstanceStruct *)utMalloc(sizeof
    (SFc2_simlwrkuka_dynamicInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_simlwrkuka_dynamicInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_simlwrkuka_dynamic;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_simlwrkuka_dynamic;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_simlwrkuka_dynamic;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_simlwrkuka_dynamic;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_simlwrkuka_dynamic;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_simlwrkuka_dynamic;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_simlwrkuka_dynamic;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_simlwrkuka_dynamic;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_simlwrkuka_dynamic;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_simlwrkuka_dynamic;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_simlwrkuka_dynamic;
...
void c2_simlwrkuka_dynamic_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_simlwrkuka_dynamic(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_simlwrkuka_dynamic(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_simlwrkuka_dynamic(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_simlwrkuka_dynamic_method_dispatcher.\n"
