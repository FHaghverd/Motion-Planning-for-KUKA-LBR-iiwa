...
static void initialize_c3_simlwrkuka_dynamic
  (SFc3_simlwrkuka_dynamicInstanceStruct *chartInstance);
static void initialize_params_c3_simlwrkuka_dynamic
  (SFc3_simlwrkuka_dynamicInstanceStruct *chartInstance);
static void enable_c3_simlwrkuka_dynamic(SFc3_simlwrkuka_dynamicInstanceStruct
  *chartInstance);
static void disable_c3_simlwrkuka_dynamic(SFc3_simlwrkuka_dynamicInstanceStruct *
  chartInstance);
static void c3_update_debugger_state_c3_simlwrkuka_dynamic
  (SFc3_simlwrkuka_dynamicInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_simlwrkuka_dynamic
  (SFc3_simlwrkuka_dynamicInstanceStruct *chartInstance);
static void set_sim_state_c3_simlwrkuka_dynamic
  (SFc3_simlwrkuka_dynamicInstanceStruct *chartInstance, const mxArray *c3_st);
static void finalize_c3_simlwrkuka_dynamic(SFc3_simlwrkuka_dynamicInstanceStruct
  *chartInstance);
static void sf_gateway_c3_simlwrkuka_dynamic
  (SFc3_simlwrkuka_dynamicInstanceStruct *chartInstance);
static void initSimStructsc3_simlwrkuka_dynamic
  (SFc3_simlwrkuka_dynamicInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static void c3_emlrt_marshallIn(SFc3_simlwrkuka_dynamicInstanceStruct
  *chartInstance, const mxArray *c3_ddq, const char_T *c3_identifier, real_T
  c3_y[7]);
static void c3_b_emlrt_marshallIn(SFc3_simlwrkuka_dynamicInstanceStruct
...
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_c_emlrt_marshallIn(SFc3_simlwrkuka_dynamicInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
...
static void c3_eml_scalar_eg(SFc3_simlwrkuka_dynamicInstanceStruct
  *chartInstance);
static void c3_eml_xgemm(SFc3_simlwrkuka_dynamicInstanceStruct *chartInstance,
  real_T c3_A[49], real_T c3_B[7], real_T c3_C[7], real_T c3_b_C[7]);
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_d_emlrt_marshallIn(SFc3_simlwrkuka_dynamicInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_e_emlrt_marshallIn(SFc3_simlwrkuka_dynamicInstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_simlwrkuka_dynamic, const
  char_T *c3_identifier);
static uint8_T c3_f_emlrt_marshallIn(SFc3_simlwrkuka_dynamicInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_eml_xgemm(SFc3_simlwrkuka_dynamicInstanceStruct *chartInstance,
  real_T c3_A[49], real_T c3_B[7], real_T c3_C[7]);
static void init_dsm_address_info(SFc3_simlwrkuka_dynamicInstanceStruct
  *chartInstance);
  ...
  (SFc3_simlwrkuka_dynamicInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_simlwrkuka_dynamic = 0U;
}
  ...
  (SFc3_simlwrkuka_dynamicInstanceStruct *chartInstance)
{
  ...
  c3_hoistedGlobal = chartInstance->c3_is_active_c3_simlwrkuka_dynamic;
  ...
  (SFc3_simlwrkuka_dynamicInstanceStruct *chartInstance, const mxArray *c3_st)
{
  ...
  chartInstance->c3_is_active_c3_simlwrkuka_dynamic = c3_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 1)),
     "is_active_c3_simlwrkuka_dynamic");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_simlwrkuka_dynamic(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_simlwrkuka_dynamicInstanceStruct *chartInstance;
  chartInstance = (SFc3_simlwrkuka_dynamicInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_simlwrkuka_dynamic_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c3_identifier)
{
  ...
  c3_y = c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_simlwrkuka_dynamic), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_simlwrkuka_dynamic);
  return c3_y;
}
...
void sf_c3_simlwrkuka_dynamic_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_simlwrkuka_dynamic_get_autoinheritance_info(void)
{
...
mxArray *sf_c3_simlwrkuka_dynamic_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_simlwrkuka_dynamic_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_simlwrkuka_dynamic(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[6],T\"ddq\",},{M[8],M[0],T\"is_active_c3_simlwrkuka_dynamic\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_simlwrkuka_dynamic_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_simlwrkuka_dynamicInstanceStruct *)
...
static void sf_opaque_initialize_c3_simlwrkuka_dynamic(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_simlwrkuka_dynamicInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_simlwrkuka_dynamic((SFc3_simlwrkuka_dynamicInstanceStruct*)
    chartInstanceVar);
  initialize_c3_simlwrkuka_dynamic((SFc3_simlwrkuka_dynamicInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_simlwrkuka_dynamic(void *chartInstanceVar)
{
  enable_c3_simlwrkuka_dynamic((SFc3_simlwrkuka_dynamicInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c3_simlwrkuka_dynamic(void *chartInstanceVar)
{
  disable_c3_simlwrkuka_dynamic((SFc3_simlwrkuka_dynamicInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_simlwrkuka_dynamic(void *chartInstanceVar)
{
  sf_gateway_c3_simlwrkuka_dynamic((SFc3_simlwrkuka_dynamicInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_simlwrkuka_dynamic(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_simlwrkuka_dynamic
    ((SFc3_simlwrkuka_dynamicInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_simlwrkuka_dynamic();/* state var info */
...
extern void sf_internal_set_sim_state_c3_simlwrkuka_dynamic(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_simlwrkuka_dynamic();/* state var info */
  ...
  set_sim_state_c3_simlwrkuka_dynamic((SFc3_simlwrkuka_dynamicInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_simlwrkuka_dynamic(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_simlwrkuka_dynamic(S);
}

static void sf_opaque_set_sim_state_c3_simlwrkuka_dynamic(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c3_simlwrkuka_dynamic(S, st);
}

static void sf_opaque_terminate_c3_simlwrkuka_dynamic(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_simlwrkuka_dynamicInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_simlwrkuka_dynamic((SFc3_simlwrkuka_dynamicInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_simlwrkuka_dynamic((SFc3_simlwrkuka_dynamicInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_simlwrkuka_dynamic(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c3_simlwrkuka_dynamic
      ((SFc3_simlwrkuka_dynamicInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_simlwrkuka_dynamic(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c3_simlwrkuka_dynamic(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_simlwrkuka_dynamic(SimStruct *S)
{
  SFc3_simlwrkuka_dynamicInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_simlwrkuka_dynamicInstanceStruct *)utMalloc(sizeof
    (SFc3_simlwrkuka_dynamicInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_simlwrkuka_dynamicInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_simlwrkuka_dynamic;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_simlwrkuka_dynamic;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_simlwrkuka_dynamic;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_simlwrkuka_dynamic;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_simlwrkuka_dynamic;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_simlwrkuka_dynamic;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_simlwrkuka_dynamic;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_simlwrkuka_dynamic;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_simlwrkuka_dynamic;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_simlwrkuka_dynamic;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_simlwrkuka_dynamic;
...
void c3_simlwrkuka_dynamic_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_simlwrkuka_dynamic(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_simlwrkuka_dynamic(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_simlwrkuka_dynamic(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_simlwrkuka_dynamic_method_dispatcher.\n"
