...
#include "c2_simlwrkuka_dynamic_dirdyn.h"
...
static void initialize_c2_simlwrkuka_dynamic_dirdyn
  (SFc2_simlwrkuka_dynamic_dirdynInstanceStruct *chartInstance);
static void initialize_params_c2_simlwrkuka_dynamic_dirdyn
  (SFc2_simlwrkuka_dynamic_dirdynInstanceStruct *chartInstance);
static void enable_c2_simlwrkuka_dynamic_dirdyn
  (SFc2_simlwrkuka_dynamic_dirdynInstanceStruct *chartInstance);
static void disable_c2_simlwrkuka_dynamic_dirdyn
  (SFc2_simlwrkuka_dynamic_dirdynInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_simlwrkuka_dynamic_dirdyn
  (SFc2_simlwrkuka_dynamic_dirdynInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_simlwrkuka_dynamic_dirdyn
  (SFc2_simlwrkuka_dynamic_dirdynInstanceStruct *chartInstance);
static void set_sim_state_c2_simlwrkuka_dynamic_dirdyn
  (SFc2_simlwrkuka_dynamic_dirdynInstanceStruct *chartInstance, const mxArray
   *c2_st);
static void finalize_c2_simlwrkuka_dynamic_dirdyn
  (SFc2_simlwrkuka_dynamic_dirdynInstanceStruct *chartInstance);
static void sf_gateway_c2_simlwrkuka_dynamic_dirdyn
  (SFc2_simlwrkuka_dynamic_dirdynInstanceStruct *chartInstance);
static void c2_chartstep_c2_simlwrkuka_dynamic_dirdyn
  (SFc2_simlwrkuka_dynamic_dirdynInstanceStruct *chartInstance);
static void initSimStructsc2_simlwrkuka_dynamic_dirdyn
  (SFc2_simlwrkuka_dynamic_dirdynInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_simlwrkuka_dynamic_dirdynInstanceStruct
  *chartInstance, const mxArray *c2_stop_sim, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_simlwrkuka_dynamic_dirdynInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_simlwrkuka_dynamic_dirdynInstanceStruct
  *chartInstance, const mxArray *c2_xdd_des, const char_T *c2_identifier, real_T
  c2_y[6]);
static void c2_d_emlrt_marshallIn(SFc2_simlwrkuka_dynamic_dirdynInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[6]);
...
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_e_emlrt_marshallIn(SFc2_simlwrkuka_dynamic_dirdynInstanceStruct
  *chartInstance, const mxArray *c2_x_des, const char_T *c2_identifier, real_T
  c2_y[7]);
static void c2_f_emlrt_marshallIn(SFc2_simlwrkuka_dynamic_dirdynInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[7]);
...
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_g_emlrt_marshallIn(SFc2_simlwrkuka_dynamic_dirdynInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[4]);
...
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_h_emlrt_marshallIn(SFc2_simlwrkuka_dynamic_dirdynInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[3]);
...
static real_T c2_mpower(SFc2_simlwrkuka_dynamic_dirdynInstanceStruct
  *chartInstance, real_T c2_a);
static void c2_eml_scalar_eg(SFc2_simlwrkuka_dynamic_dirdynInstanceStruct
  *chartInstance);
...
static uint8_T c2_j_emlrt_marshallIn
  (SFc2_simlwrkuka_dynamic_dirdynInstanceStruct *chartInstance, const mxArray
   *c2_b_is_active_c2_simlwrkuka_dynamic_dirdyn, const char_T *c2_identifier);
static uint8_T c2_k_emlrt_marshallIn
  (SFc2_simlwrkuka_dynamic_dirdynInstanceStruct *chartInstance, const mxArray
   *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_simlwrkuka_dynamic_dirdynInstanceStruct
  *chartInstance);
  ...
  (SFc2_simlwrkuka_dynamic_dirdynInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_simlwrkuka_dynamic_dirdyn = 0U;
}
  ...
  (SFc2_simlwrkuka_dynamic_dirdynInstanceStruct *chartInstance)
{
  ...
  c2_b_hoistedGlobal = chartInstance->c2_is_active_c2_simlwrkuka_dynamic_dirdyn;
   ...
   *c2_st)
{
  ...
  *c2_stop_sim = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c2_is_active_c2_simlwrkuka_dynamic_dirdyn =
    c2_j_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 4)),
    "is_active_c2_simlwrkuka_dynamic_dirdyn");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_simlwrkuka_dynamic_dirdyn(chartInstance);
  ...
  (SFc2_simlwrkuka_dynamic_dirdynInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_simlwrkuka_dynamic_dirdyn(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_simlwrkuka_dynamic_dirdynInstanceStruct *chartInstance;
  chartInstance = (SFc2_simlwrkuka_dynamic_dirdynInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c2_simlwrkuka_dynamic_dirdyn_get_eml_resolved_functions_info
  (void)
{
   ...
   *c2_b_is_active_c2_simlwrkuka_dynamic_dirdyn, const char_T *c2_identifier)
{
  ...
  c2_y = c2_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_simlwrkuka_dynamic_dirdyn), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_simlwrkuka_dynamic_dirdyn);
  return c2_y;
}
...
void sf_c2_simlwrkuka_dynamic_dirdyn_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_simlwrkuka_dynamic_dirdyn_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_simlwrkuka_dynamic_dirdyn_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_simlwrkuka_dynamic_dirdyn_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_simlwrkuka_dynamic_dirdyn(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[6],T\"stop_sim\",},{M[1],M[5],T\"x_des\",},{M[1],M[7],T\"xd_des\",},{M[1],M[8],T\"xdd_des\",},{M[8],M[0],T\"is_active_c2_simlwrkuka_dynamic_dirdyn\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_simlwrkuka_dynamic_dirdyn_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_simlwrkuka_dynamic_dirdyn(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_simlwrkuka_dynamic_dirdynInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_simlwrkuka_dynamic_dirdyn
    ((SFc2_simlwrkuka_dynamic_dirdynInstanceStruct*) chartInstanceVar);
  initialize_c2_simlwrkuka_dynamic_dirdyn
    ((SFc2_simlwrkuka_dynamic_dirdynInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_simlwrkuka_dynamic_dirdyn(void *chartInstanceVar)
{
  enable_c2_simlwrkuka_dynamic_dirdyn
    ((SFc2_simlwrkuka_dynamic_dirdynInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_simlwrkuka_dynamic_dirdyn(void
  *chartInstanceVar)
{
  disable_c2_simlwrkuka_dynamic_dirdyn
    ((SFc2_simlwrkuka_dynamic_dirdynInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_simlwrkuka_dynamic_dirdyn(void
  *chartInstanceVar)
{
  sf_gateway_c2_simlwrkuka_dynamic_dirdyn
    ((SFc2_simlwrkuka_dynamic_dirdynInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_simlwrkuka_dynamic_dirdyn
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_simlwrkuka_dynamic_dirdyn
    ((SFc2_simlwrkuka_dynamic_dirdynInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_simlwrkuka_dynamic_dirdyn();/* state var info */
...
extern void sf_internal_set_sim_state_c2_simlwrkuka_dynamic_dirdyn(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_simlwrkuka_dynamic_dirdyn();/* state var info */
  ...
  set_sim_state_c2_simlwrkuka_dynamic_dirdyn
    ((SFc2_simlwrkuka_dynamic_dirdynInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_simlwrkuka_dynamic_dirdyn
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c2_simlwrkuka_dynamic_dirdyn(S);
}

static void sf_opaque_set_sim_state_c2_simlwrkuka_dynamic_dirdyn(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c2_simlwrkuka_dynamic_dirdyn(S, st);
}

static void sf_opaque_terminate_c2_simlwrkuka_dynamic_dirdyn(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_simlwrkuka_dynamic_dirdynInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_simlwrkuka_dynamic_dirdyn
      ((SFc2_simlwrkuka_dynamic_dirdynInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_simlwrkuka_dynamic_dirdyn
    ((SFc2_simlwrkuka_dynamic_dirdynInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_simlwrkuka_dynamic_dirdyn(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_simlwrkuka_dynamic_dirdyn(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_simlwrkuka_dynamic_dirdyn(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_simlwrkuka_dynamic_dirdyn(SimStruct *S)
{
  SFc2_simlwrkuka_dynamic_dirdynInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_simlwrkuka_dynamic_dirdynInstanceStruct *)utMalloc
    (sizeof(SFc2_simlwrkuka_dynamic_dirdynInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_simlwrkuka_dynamic_dirdynInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_simlwrkuka_dynamic_dirdyn;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_simlwrkuka_dynamic_dirdyn;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_simlwrkuka_dynamic_dirdyn;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_simlwrkuka_dynamic_dirdyn;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_simlwrkuka_dynamic_dirdyn;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_simlwrkuka_dynamic_dirdyn;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_simlwrkuka_dynamic_dirdyn;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_simlwrkuka_dynamic_dirdyn;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_simlwrkuka_dynamic_dirdyn;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_simlwrkuka_dynamic_dirdyn;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_simlwrkuka_dynamic_dirdyn;
...
void c2_simlwrkuka_dynamic_dirdyn_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_simlwrkuka_dynamic_dirdyn(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_simlwrkuka_dynamic_dirdyn(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_simlwrkuka_dynamic_dirdyn(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_simlwrkuka_dynamic_dirdyn_method_dispatcher.\n"
